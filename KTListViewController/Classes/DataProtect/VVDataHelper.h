...
/**
 ...
 @return 返回结果
 */
static inline NSArray * _Nullable vv_safeArray(id _Nullable array)
{
...
/**
 ...
 @return 返回结果
 */
static inline NSMutableArray * _Nullable vv_safeMutableArray(id _Nullable mutableArray)
{
...
/**
 ...
 @return 返回结果
 */
static inline NSDictionary * _Nullable vv_safeDict(id _Nullable dict)
{
...
/**
 ...
 @return 返回结果
 */
static inline NSMutableDictionary * _Nullable vv_safeMutableDict(id _Nullable mutableDict)
{
...
/**
 ...
 @return 返回结果
 */
static inline NSString * _Nullable vv_safeStr(id _Nullable str)
{
...
/**
 ...
 @return 返回结果
 */
static inline NSString * _Nullable vv_safeStrWithDefalut(id _Nullable str,NSString * _Nullable defaultStr)
{
    NSString *temp = vv_safeStr(str);
...
/**
 ...
 @return 返回结果
 */
static inline NSObject * _Nullable vv_safeObj(id _Nullable obj)
{
...
static inline NSNumber * _Nullable vv_safeNumber(id _Nullable obj)
{
...
static inline NSMutableArray * _Nullable vv_mutableArray(id _Nullable mutableArray)
{
    if ([mutableArray isKindOfClass:[NSMutableArray class]]) {
        return mutableArray;
