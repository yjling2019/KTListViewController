//
//  KTCustomCollectionViewLayout.m
//  KOTU
//
...
@implementation KTWaterfallFlowLayout
...
{
    if ([self.delegate respondsToSelector:@selector(useCustomContentSize)] &&
        [self.delegate respondsToSelector:@selector(customContentSize)] &&
        [self.delegate useCustomContentSize]) {
        ///使用自定义contentSize,、
        return [self.delegate customContentSize];
    }
